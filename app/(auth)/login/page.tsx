...
function LoginPage() {
  return (
    <div className='flex flex-col lg:flex-row min-h-screen'>
        <div className="hidden lg:flex lg:flex-3/4 bg-neutral-50 justify-center items-center">
          <Image src="/images/auth/bg-login.png" alt="Login Illustration" width={580} height={800}/>
        </div>
